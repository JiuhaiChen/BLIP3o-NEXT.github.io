#!/usr/bin/env python3
"""
Plot GenEval GRPO training rewards from wandb export CSV file.
"""
...
def plot_geneval_rewards():
    """Read CSV and plot training rewards."""
    ...
    # Read the CSV file
    csv_file = 'plot/wandb_export_2025-08-03T20_27_02.633-07_00.csv'
    ...
    y_col = 'Qwen3-1.7B-GRPO-16-beta-0.001-lr-5e-6-final-2-nodes-geneval - train/rewards/reward_len/mean'
    ...
    # Filter out NaN values and limit to training steps <= 450
    data = df[[x_col, y_col]].dropna()
    data = data[data[x_col] <= 450]
    ...
    # Save the plot
    output_path = os.path.join(plot_dir, 'geneval_train_reward.png')
